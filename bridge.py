...
{}\n".format(self._analysis_parameter['structure'],
    ...
    def init_interactive_graph(self):
        ...
        if self.interactive_graph is not None:
            ...
            self.checkBox_centralities_avg.clicked.disconnect(self.interactive_graph.set_colors)
            self.horizontalSlider_nodes.sliderMoved.disconnect(self.interactive_graph.set_nodesize)
        ...
        self.checkBox_centralities_avg.clicked.connect(self.interactive_graph.set_colors)
        self.horizontalSlider_nodes.sliderMoved.connect(self.interactive_graph.set_nodesize)
