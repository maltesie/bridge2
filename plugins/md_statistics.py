...
def update(parent):
    ...
    if main_window._analysis_type == 'ww': 
        ...
        ui.groupBox_joint_occupancy.setTitle('Timeseries of Sum of Water Wires')
...
class Ui_GroupBox(object):
    ...
    def retranslateUi(self, GroupBox):
        ...
        self.pushButton_save_occupancy.setText(QCoreApplication.translate("GroupBox", u"Compute", None))
#if QT_CONFIG(tooltip)
        ...
        self.pushButton_save_timeseries.setText(QCoreApplication.translate("GroupBox", u"Compute", None))
#if QT_CONFIG(tooltip)
        ...
        self.pushButton_save_jo.setText(QCoreApplication.translate("GroupBox", u"Compute", None))
#if QT_CONFIG(tooltip)
